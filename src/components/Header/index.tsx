        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-4">
              <Link
                href="/"
                className={`navbar-logo mb-6 inline-block max-w-[120px] ${
                  sticky ? "py-2" : "py-5"
                } `}
              >
                {pathUrl !== "/" ? (
                  <>
                    <Image
                      ...
                      width={60}
                      height={16}
                      className="header-logo w-full dark:hidden h-auto"
                      priority
                    />
                    <Image
                      src="/logo_transparent.png"
                      ...
                      width={60}
                      height={16}
                      className="header-logo hidden w-full dark:block h-auto"
                      priority
                    />
                  </>
                ) : (
