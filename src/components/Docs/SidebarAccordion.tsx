...
const SidebarAccordion: React.FC = () => {
  ...
  return (
    <nav className="block md:hidden w-screen max-w-full left-1/2 -translate-x-1/2 relative mt-8 mb-4 px-2">
      <div className="rounded-xl bg-white/80 dark:bg-dark-2/80 shadow border border-gray-200 dark:border-dark-3/20 w-full">
        <button
