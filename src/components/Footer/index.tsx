        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              <Link href="/" className="mb-6 inline-block max-w-[120px]">
                <Image
              ...
              <p className="mb-8 max-w-[270px] text-base text-gray-7">
                Optima AI Solutions builds privacy-first  AI tools for developers and teams. Trio Agent is your all-in-one local AI app builder—fast, secure, and fully under your control.
              </p>
              {/* Contact Details */}
              <div className="mb-6 text-base text-gray-7 space-y-1">
                <div>
                  <span className="font-semibold text-white">Email:</span> <a href="mailto:hello@optimaai.cc" className="hover:text-primary underline">hello@optimaai.cc</a>
                </div>
                <div>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                <li>
                  <Link href="/" className="mb-3 inline-block text-base text-gray-7 hover:text-primary">Home</Link>
                </li>
                <li>
                  <Link href="/trio-download" className="mb-3 inline-block text-base text-gray-7 hover:text-primary">Download</Link>
                </li>
                <li>
                  <Link href="/pricing" className="mb-3 inline-block text-base text-gray-7 hover:text-primary">Pricing</Link>
                </li>
                <li>
                  <Link href="/blog" className="mb-3 inline-block text-base text-gray-7 hover:text-primary">Blog</Link>
                </li>
                <li>
                  <Link href="/about" className="mb-3 inline-block text-base text-gray-7 hover:text-primary">About</Link>
                </li>
                <li>
                  <Link href="/contact" className="mb-3 inline-block text-base text-gray-7 hover:text-primary">Contact</Link>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                <li>
                  <Link href="/docs" className="mb-3 inline-block text-base text-gray-7 hover:text-primary">Docs</Link>
                </li>
                <li>
                  <Link href="/tutorials" className="mb-3 inline-block text-base text-gray-7 hover:text-primary">Tutorials</Link>
                </li>
              </ul>
            </div>
          </div>
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                <li>
                  <Link href="/privacy" className="mb-3 inline-block text-base text-gray-7 hover:text-primary">Privacy Policy</Link>
                </li>
                <li>
                  <Link href="/terms" className="mb-3 inline-block text-base text-gray-7 hover:text-primary">Terms of Service</Link>
                </li>
                <li>
                  <Link href="/refund" className="mb-3 inline-block text-base text-gray-7 hover:text-primary">Refund Policy</Link>
                </li>
              </ul>
            </div>
          </div>
          {/* Removed template product links. Add more company/product links here if needed. */}
          {/* Removed duplicate/unused Useful Links section. */}
        </div>
      </div>
            ...
            <div className="w-full px-4 md:w-1/3 lg:w-1/2">
              <div className="my-1 flex justify-center md:justify-end">
                <p className="text-base text-gray-7">
                  &copy; {new Date().getFullYear()} Optima AI Solutions Inc. All rights reserved.
                </p>
              </div>
            </div>
          </div>
