      ...
      <div className="container">
        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="What is Trio Agent?"
              answer="Trio Agent is a local-first AI app builder that lets you create, deploy  your fullstack apps, and use AI-powered tools right on your machine—no cloud required. Fast, private, and fully under your control."
            />
            <SingleFaq
              question="How private is my data with Trio Agent?"
              answer="All processing happens locally on your device. Your code, data, and prompts never leave your machine unless you choose to share them."
            />
            <SingleFaq
              question="What is the 2 million context window?"
              answer="Optima AI's Trio Model supports up to 2 million tokens of context, letting you work with huge codebases, documents, or conversations without losing track."
            />
          </div>

          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="What platforms does Trio Agent support?"
              answer="Trio Agent runs on Windows, Mac, and Linux. Cross-platform collaboration is built-in."
            />
            <SingleFaq
              question="How is pricing structured?"
              answer="We offer a free Personal plan, a Pro plan with advanced features, and a Team plan for organizations. All plans include privacy-first AI and blazing-fast performance."
            />
            <SingleFaq
              question="Where can I get support?"
              answer="You can reach out via our website, join the community, or contact us directly for Pro/Team support."
            />
          </div>
        </div>
      </div>
