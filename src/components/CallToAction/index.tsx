            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[570px] text-center">
                ...
                <Link
                  ...
                  className="inline-block rounded-md border border-transparent bg-secondary px-7 py-3 text-base font-medium text-white transition hover:bg-[#0BB489] shadow-lg"
                  target="_blank"
                >
                  Download Trio AI Agent
                </Link>
              </div>
            </div>
          </div>
